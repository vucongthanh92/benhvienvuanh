...
<div class="content">
	<div class="content_i">
<form action = '<?php echo BASE_URL_ADMIN;?>video/add' method = 'post' enctype = "multipart/form-data">
<table >
	 <tr>
		<td class = 'title_td'>Tiêu đề</td>
		<td><input type = 'text' name = 'title_vn' size = '100' value = ''></td>
	</tr>
	<tr>
    ...
    <tr>
		...
		<td><input type = 'text' name = 'link' size = '100' value = ''></td>
	</tr>
	<tr>
