...
/*	 * liet ke danh sach du lieu	 */	
 ...
 }		/*	 * kich hoat or khoa tin	 */	
 
 function ticlockactive($data,$id)
 {
	 $this->where('Id = '.$id);		
	 $this->update(TBL_PAGEHTML,$data);			
 }
 ...
 function del_allcheck($data)
 {
	 ...
	 {
		 $this->delete(TBL_PAGEHTML,'Id = '.$item);
	 }	
 }
 		/*	 * delete mot dong	 */	
 function del_onecheck($id)
 {
	 $this->delete(TBL_PAGEHTML,'Id = '.$id);	
 }
