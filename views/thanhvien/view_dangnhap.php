...
<form method="post" action="<?=BASE_URL.'dang-nhap.html' ?>" novalidate="novalidate"><input type="hidden" value="~/" name="ReturnUrl" id="ReturnUrl">            <div class="login_form">
                ...
                <div class="row">
                    ...
                    <input type="text" value="<?=$data['email'] ?>" placeholder="Địa chỉ email" name="email" id="Email" data-val-required="Vui lòng nhập email" data-val="true" class="text"><br class="clean">
                </div>
...
<form method="post" action="<?=BASE_URL.'dang-ky.html' ?>" novalidate="novalidate">
           <div class="re_form">
                ...
                <div class="row">
                    <span class="row_L">EMAIL<font class="other_color_star">*</font></span>
                    <input type="text" value="" placeholder="Địa chỉ email" name="email" id="RegisterEmail" class="text"><br class="clean">
                </div>
...
<option value="1">Chị</option>
                    ...
                    <input type="text" value="" style="width: 130px !important;" placeholder="Họ tên" name="name" id="name"  class="text"><br class="clean">
                </div>
                
                <div class="row">
                    <span class="row_L1">ĐIỆN THOẠI<font class="other_color_star">*</font></span>
                    <input type="text" value="" placeholder="Điện thoại di động" name="Mobile" id="Mobile" data-val="true" class="text"><br class="clean">
                </div>
