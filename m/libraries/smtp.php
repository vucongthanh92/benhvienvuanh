...
function SendMail($frommail,$tomail,$fromfullname="PHUTUNGXEMAYHC.COM",$subject,$message)
{
      ...
      $smtp_host ='125.253.118.20';//Dia chi mail server
      $admin_email = 'lienhe@phutungxemayhc.com';//User duoc khai bao tren mail server
      $smtp_username = 'lienhe@phutungxemayhc.com';//User duoc khai bao tren mail server
      $smtp_password = 'Rt9GRNdI';//Pass cua email nay
      return (@smtpmail($tomail,$subject,$message,$headers,$smtp_host, $smtp_username, $smtp_password,$admin_email));
}
function SendMailAttachFile($frommail,$tomail,$subject,$message,$headers,$fromfullname="CÔNG TY TNHH TM-DV TIN HỌC LONG VŨ")
{
      $from= $fromfullname." <".$frommail.">";
      $smtp_host ='125.253.118.20';//Dia chi mail server
      $admin_email = 'lienhe@phutungxemayhc.com';//User duoc khai bao tren mail server
